    ...
    <div className='flex flex-col min-h-screen'>
        <main className='container mx-auto w-screen h-screen lg:max-w-screen-lg flex-1'>
            <div className='shadow-md shadow-slate-200 content-center flex-row items-center justify-center'>
                ...
                <div className=' justify-center align-middle flex content-center p-4'>
                    <button onClick={routotosendeth} className='text-center text-white font-bold rounded py-2 w-2/12 focus:outline-none bg-gray-900 border-2 border-gray-400'>Send Ether</button>
                </div>
                <hr></hr>
                <div>
                    <ul className='p4'>
